...
function toggleAdminTheme() {
  ...
  try { localStorage.setItem('theme', nextTheme); } catch (_error) {  }
...
function toggleAdminSidebar() {
  ...
  try { localStorage.setItem('adminSidebarCollapsed', document.body.classList.contains('admin-sidebar-collapsed') ? '1' : '0'); } catch (_error) {  }
}
...
function destroyAdminPage() {
  ...
  if (window.easyMDE) {
    try { window.easyMDE.toTextArea(); } catch (_error) {  }
    window.easyMDE = null;
  }
